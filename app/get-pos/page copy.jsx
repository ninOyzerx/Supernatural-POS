...
<header className="bg-primary dark:bg-gray-800 text-primary-foreground py-5 md:py-8 lg:py-10 mb-[-50px]">
  <div className="container mx-auto px-4 md:px-6 lg:px-8">
    <div className="max-w-3xl mx-auto text-center space-y-4">
      <h1 className={`text-3xl md:text-2xl lg:text-4xl font-bold ${darkMode ? 'text-black' : 'text-white-700'}`}>
        ยกระดับธุรกิจของคุณด้วยระบบ POS ที่มีประสิทธิภาพ
      </h1>
      <p className={`text-lg md:text-xl lg:text-3xl text-primary-foreground/80 ${darkMode ? 'text-gray-300' : 'text-white-700'}`}>
